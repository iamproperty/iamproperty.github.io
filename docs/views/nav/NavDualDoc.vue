...
<template>
  <main>
    ...
    <div class="container pb-0">
      ...
      <p>
        Our navigation bar provides users with consistent links to the main sections of the site or platform. The dual
        variant presents the key navigation items across two horizontal lists on desktop, which are collapsed into a
        list behind a menu icon on tablet and mobile. Just like the Navbar, the Navbar-dual can be added in default or
        deep slate variant.
      </p>
      <p>
        The primary list navigation items are dropdown which displays the mega menu, whilst the secondary list of items
        are standard navigation links. The primary list is appended with a button (usually primary) and can also include
        a compact button if needed. On desktop this is positioned at the end of the list to stand out from the rest of
        the list, on tablet and mobile it is housed within the collapsed list behind the menu icon.
      </p>
    </div>
    ...
    <div class="container pt-4 pb-0">
      <h2>Usage notes</h2>
      <p>
        There should be no more than 6 navigation items (not including the button) in the primary navbar before the
        secondary navigation lists.
      </p>
      <p>
        On tablet and mobile, all menu items are hidden behind a menu icon. This icon has a label with it on tablet,
        which then becomes hidden on mobile devices to avoid spatial constraints.
      </p>
      <p>
        Buttons used within the action area of the primary navbar can be used to direct user to a page, modal or trigger
        the menu (see ‘Menu’ style guide)
      </p>
    </div>
