<template>
  <main>
    ...
    <div class="container pb-0">
      ...
      <p class="lead">Allows users to navigate deeper into any section of the site or platform as long as the user has the relevant permissions.</p>
      <p>Our navbar-mega menu is triggered initially by selecting an item from the dropdown menu within the navbar. Upon doing so, a sub-menu appears which displays each of the sub sections across the columns of equal width. Selecting one of these items can either expand the section menu or navigate directly to a page depending on the rule applied.</p>
    ...
    <div class="container pt-4 pb-0">
      ...
      <p>Search is a secondary state, it only appears when the user clicks the ‘search’ secondary compact button, overlapping the Default state and presenting an input field. </p>
    ...
    <div class="container pt-4 pb-0">
      ...
      <ol>
        ...
        <li>Section menu tertiary slot (please note this slot if available on tablet and mobile if links are displayed like 5 & 6)</li>
      </ol>
      ...
      <p>On mobile and tablet, an addition plus icon is displayed on the left of each sub-menu item to indicate that clicking the item reveals more content. If the item does not contain the plus icon it indicates that this is a navigational link.</p>
      <p>The title of each section menu (text within the gradient section) is H3 styling and provides a context to the section menu displayed.</p>
      <p>On desktop, the tertiary slot of the section menu can house cards or can be used for further text navigational links (displayed in the styling of the primary and secondary slots of the section menu) </p>
