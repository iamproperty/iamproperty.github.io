<script setup>
  import MultiStepModal from '@/components/MultiStepModal/MultiStepModal.vue';
...
<template>
  ...
  <main>
    ...
    <Integration component="multi-Step" componentName="iam-multi-step">
      <template #web-component>
        <pre><code>{{`<dialog><iam-multi-step-modal><form>
  <span class="h3">Multi-step modal title</span>
  ...
  <button class="btn btn-primary colour-success" type="submit">Register</button>
      ...
      <template #vue-component>
        <pre><code>{{`<script setup>import MultiStepModal from '@/components/MultiStepModal/MultiStepModal.vue</script>
        
<dialog><MultiStepModal><form>
  <span class="h3">Multi-step modal title</span>
...
</form></MultiStepModal></dialog>`}}</code></pre>
      </template>
