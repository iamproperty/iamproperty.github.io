      ...
      <div class="container">
        <div class="form-panel">
          ...
          <div>
            ...
            <input
              ...
              id="input11"
              name="input11"
              placeholder="Optional placheolder text"
              required=""
              list="addresses"
              data-change-events='[
            ...
            <datalist id="addresses">
              <option
                value="5 Sunset Road, Leeds, West Yorkshire…"
                data-values='{ "property": "5 Sunset Road, Leeds, West Yorkshire…", "value": "2000,010", "tenure": "freehold", "property-type": "residential", "method-of-sale": ""}'
              ></option>
              <option
                value="5 Sunset Road, York, West Yorkshire, Y…"
                data-values='{ "property": "5 Sunset Road, York, West Yorkshire…", "value": "2000,010", "tenure": "freehold", "property-type": "residential", "method-of-sale": ""}'
              ></option>
            </datalist>
            <button class="suffix fa-solid fa-search">
        ...
        <div class="form-panel js-hide" id="property-details">
          ...
          <form id="form" novalidate action="/standalone/crm-mb/page3">
            ...
            <div class="pb-5">
              <span id="property" class="d-inline-block"></span>
              <i
                role="button"
                class="fa-solid fa-trash text-primary ms-3"
                data-click-events='[
            ...
            <Notification>
              <strong>Please ensure the details from your CRM are correct: </strong> If they are not correct, please go
              to the property details within the CRM to update.
            </Notification>

            <div class="text-end pt-3">
              <button type="submit" class="btn btn-primary me-auto">Continue</button>
            </div>
          </form>
        </div>
