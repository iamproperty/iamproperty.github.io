<script lang="ts" setup>
  ...
  if (localStorage.getItem('tags') != null) tags.value = JSON.parse(localStorage.getItem('tags'));
  ...
  const filterCases = async (event) => {
    ...
    if (event && event.detail.page) formData.append('page', event.detail.page);
    else if (tableComponent.hasAttribute('data-page'))
      formData.append('show', tableComponent.getAttribute('data-page'));

    if (tableComponent.hasAttribute('data-show')) formData.append('show', tableComponent.getAttribute('data-show'));
  ...
  <main>
    ...
    <Search class="md-col-start-7">
      <label data-v-eb8d413a="">
        Property address <span class="optional-text"></span
        ><span data-v-eb8d413a="">
          <input
            data-v-eb8d413a=""
            type="hidden"
            name="client"
          ...
          <input
            ...
            list=""
            data-list="" />
          <span data-v-eb8d413a="" class="suffix fa-regular fa-search" aria-hidden="true"></span
        ></span>
    ...
    <div class="admin-panel md-col-end-4 md-row-span-2">
      ...
      <Rankings data-v-c2a3d511="" data-max="12" class="leaderboard-scroll hide-podium">
        <table data-v-c2a3d511="">
          <thead data-v-c2a3d511="">
            <tr data-v-c2a3d511="">
              <th data-v-c2a3d511="">Company</th>
              <th data-v-c2a3d511="">Sales</th>
            </tr>
          </thead>
          <tbody data-v-c2a3d511="">
            <tr data-v-c2a3d511="">
              <th data-v-c2a3d511="">
                <iam-rank class="rank--medal first-position" data-position="1st">1st</iam-rank>Pinnacle Homes<progress
                  max="12"
                  value="11"
                ></progress>
              </th>
              <td data-v-c2a3d511="">11</td>
            </tr>
            <tr data-v-c2a3d511="">
              <th data-v-c2a3d511="">Meadowbrook Estates<progress max="12" value="9"></progress></th>
              <td data-v-c2a3d511="">9</td>
            </tr>
            <tr data-v-c2a3d511="">
              <th data-v-c2a3d511="">KeyHaven Residential<progress max="12" value="8"></progress></th>
              <td data-v-c2a3d511="">8</td>
            </tr>
            <tr data-v-c2a3d511="" class="highlighted">
              <th data-v-c2a3d511="">Deacon &amp; partners<progress max="12" value="11"></progress></th>
              <td data-v-c2a3d511="">11</td>
            </tr>
            <tr data-v-c2a3d511="">
              <th data-v-c2a3d511="">Pinnacle Homes<progress max="12" value="11"></progress></th>
              <td data-v-c2a3d511="">11</td>
            </tr>
            <tr data-v-c2a3d511="">
              <th data-v-c2a3d511="">Pinnacle Homes<progress max="12" value="11"></progress></th>
    ...
    <div class="admin-panel">
      ...
      <Table
        id="table"
        class="table--cta table--fullwidth"
        @search-submit="filterCases"
        @update-show="filterCases"
        @update-page="filterCases"
        :data-page="page"
        :data-pages="pages"
        :data-show="per_page"
        :data-total="total"
      >
        <form slot="before" @change="filterCases" id="filter">
          <Actionbar data-search="">
            <label class="tag tag--toggle" slot="filters"
              ><span class="optional-text"></span><input type="radio" name="casetype" value="new" />New prospect</label
            >

            <label class="tag tag--toggle" slot="filters"
              ><span class="optional-text"></span><input type="radio" name="casetype" value="chase" />Chase
              prospect</label
            >

            <label class="tag tag--toggle" slot="filters"
              ><span class="optional-text"></span><input type="radio" name="casetype" value="collect" />Collect
              payment</label
            >
        ...
        <table>
          <thead>
            <tr>
              <th
                data-output="<div class='dialog__wrapper'>
              ...
              <td>
                <div class="dialog__wrapper">
                  <button
                    ...
                    popovertarget="menu3314748953277"
                    aria-haspopup="true"
                    aria-controls="menu3314748953277"
                    style="anchor-name: --menu3314748953277"
                  >
                    Lorum ipsum
                  </button>
                  <iam-menu
                    class="dialog--fix dialog--list"
                    id="menu3314748953277"
                    popover="auto"
                    role="menu"
                    style="position-anchor: --menu3314748953277"
                    ><button class="btn btn-action" data-single="" role="menuitem" tabindex="0" autofocus="true">
                      View task</button
                    ><button class="btn btn-action" data-single="" role="menuitem" tabindex="0">
