    ...
    <div class="d-flex align-items-start">
      ...
      <div>
        ...
        <span class="d-block mb-2">
          ...
          <span class="pe-3 pb-1 d-inline-block"
            ><strong>Assignee:</strong>
            <span class="d-inline-block text-start" data-value="Amanda Knight"
              ><InlineEdit @inline-edit-save="addColour(tags)">
    ...
    <div class="d-flex align-items-start">
      ...
      <div>
        ...
        <span class="d-block mb-2">
          ...
          <span class="pe-3 pb-1 d-inline-block"
            ><strong>Assignee:</strong>
            <span class="d-inline-block text-start" data-value="James Lambert"
              ><InlineEdit @inline-edit-save="addColour(tags)">
                <Multiselect data-label="" data-name="users2" data-url="/users.json?search=" class="mb-0" data-single>
