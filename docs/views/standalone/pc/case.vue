  ...
  <main>
    ...
    <div v-if="onward" class="pt-0 pb-3">
      <Notification data-status="info" class="colour-info" role="alert">
        ...
        It has been identified there is a known onward purchase linked to this case, add onward purchase via the toolbox
        on this case preofile.
    ...
    <div class="admin-panel md-col-end-6 d-md-flex flex-column">
      ...
      <Notification data-status="danger" class="colour-danger" role="alert">
        ...
        <br />
        Alert message will display here<i class="fa-solid fa-triangle-exclamation" aria-hidden="true" slot="icon"></i>
      </Notification>
