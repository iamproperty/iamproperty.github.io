  ...
  <main>
    ...
    <Header>
      ...
      <ul class="tick-list h4 mb-0 pb-3">
        <li class="tick--loading pb-1">Fetching data</li>
        <li class="tick--loading pb-1">Fetching data</li>
        <li class="tick--loading pb-1">Fetching data</li>
        <li class="tick--loading pb-1">Fetching data</li>
      </ul>
      ...
      <p slot="panel" class="pb-2">
        Forecasted time saved if this transaction uses Premium Conveyancing. <a href="#details">Find out more</a>
      </p>
    ...
    <div class="admin-panel" id="details">
