...
<template>
  <main>
    ...
    <Header>
      <Notification class="" slot="before"
        >This transaction is not eligible for Premium Conveyancing: See eligibility criteria below for more
    ...
    <div class="feature feature--danger mb-2">
      <strong>21 days for current area search times</strong><Tooltip data-type="info"></Tooltip> This is longer than
      usual
    </div>
    <div class="feature feature--loading mb-2">Fetching data</div>
    <div class="feature feature--missing mb-2">Search time is unavailable</div>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr class="border-0 no-hover">
              ...
              <td>
                <Notification data-status="warning" class="notification--no-bg mb-0"
                  >A court order has been issued restricting the sale, transfer, or disposal of this property without
                  prior permission from the court. This restriction ensures that no legal or financial actions are taken
                  that would affect the property until the order is lifted or varied by the court.</Notification
                >
    ...
    <p class="mw-100 pb-3 small">
      AI insights legal statement - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
      incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
      nisi. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
    ...
    <div class="container mb-5 text-center">
      <div class="bg-info px-3 pt-5 rounded rounded-3 gradient-primary">
        ...
        <a href="https://iamproperty.github.io/" class="btn btn-primary colour-warning mb-5">Download assets</a>
      </div>
    </div>
  </main>
</template>
