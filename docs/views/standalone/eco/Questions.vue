...
<template>
  <div class="insights-panel bg-primary">
    <div class="text-center">
      ...
      <Search
        id="question-search"
        class="search--stylised mb-4"
        @option-selected="
          (event) => {
            $router.push({ path: '/standalone/hub-question', query: { question: event.detail.value } });
          }
        "
      >
        <input
        ...
        <datalist id="questions" slot="datalist">
          <div class="optgroup" value="Win:">
            <option
              data-product="mtk"
              data-feature="marketAppraisalsOverview"
              data-disabled="https://iamproperty.com/ecosystem/marketing-toolkit/"
              title="To unlock this insight you’ll need the Marketing Toolkit - click the insight to find out more"
            >
              Show me stock currently on market most likely to switch
            </option>
