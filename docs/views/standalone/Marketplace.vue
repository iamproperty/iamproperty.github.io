<template>
  <div>
    <Nav logo="property" class="nav--marketplace">
      <span class="h6 text-muted">Services</span>

      <a href="/" class="text-decoration-none mb-4 d-flex justify-content-between align-items-center">
      ...
      <a href="/" class="text-decoration-none mb-5 d-flex justify-content-between align-items-center">
      ...
      <a href="/" class="nav__featured-link text-decoration-none pb-4 border-top pt-3 d-block mb-0">
        <span class="row">
          <span class="col mw-fit-content"><i class="icon fs-1 fa-user"></i></span>
          <span class="col">
            <span Class="h5">Control panel</span>
      ...
      <a href="/" class="nav__featured-link text-decoration-none pb-4 border-top pt-3 d-block mb-0">
        <span class="row">
          ...
          <span class="col">
            <span Class="h5">Quick start guide & FAQ</span>
            <span class="text-muted">
      ...
      <a href="/" class="nav__featured-link text-decoration-none pb-4 border-top pt-3 d-block mb-0">
        <span class="row">
          <span class="col mw-fit-content"><Icon id="chat" class="fs-1 m-0"></Icon></span>
          <span class="col">
