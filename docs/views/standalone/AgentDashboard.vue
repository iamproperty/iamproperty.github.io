<template>
  <div>
    <Nav
      logo="movebutler"
      class="nav--marketplace"
      propertylink="/standalone/marketplace"
      movebutlerlink="/standalone/movebutler"
      iamsoldlink="/standalone/agent"
    >
    </Nav>
    <main class="main--marketplace">
      <form id="tableFilters" class="full-width">
            ...
            <div class="col-md-3 mw-fit-content">
              <div class="dialog__wrapper dialog__wrapper--md-right">
                <button
                  ...
                  type="button"
                >
                  <span class="empty"><i class="fa-regular fa-users me-1" aria-hidden="true"></i> Everybody</span
        ...
        <div class="container">
          <span class="h4"
            ><span data-query="Added by & Date added"></span>
            <div class="form-control__wrapper form-control--inline-text">
              <label for="clients-added">Clients added </label
              ><select id="clients-added" class="form-select" data-filter="Date added">
          ...
          <div class="row tab-focus">
            ...
            <div class="col-sm-4 col-md-3">
              <label for="due_diligience_incomplete"
                ><Card class="card--filter colour-danger" data-total="" data-query="Due diligence == Incomplete"
                  >Due diligence incomplete</Card
                ></label
              >
            </div>
            <div class="col-sm-4 col-md-3">
              <label for="due_diligience_requires_approval"
                ><Card class="card--filter colour-warning" data-total="" data-query="Due diligence == Requires approval"
                  >Due diligence requires approval</Card
                ></label
              >
            </div>
            <div class="col-sm-4 col-md-3">
              <label for="due_diligience_verified"
                ><Card class="card--filter colour-success" data-total="" data-query="Due diligence == Verified"
                ...
                <div class="col-6 col-md-5">
                  <div class="form-control__wrapper">
                    ...
                    <input
                      ...
                      type="text"
                      class="form-control"
                      data-search="Client, Transaction address"
                    />
                  </div>
                </div>
                <div class="col-6 ms-auto col-md mw-fit-content">
                  <button class="btn btn-secondary me-0 d-block w-100 btn-filter" type="button" data-modal="filters">
                ...
                <div class="col d-none d-sm-block col-md mw-fit-content">
                  <div class="btn btn-secondary">
                    ...
                    <select type="select" name="sort" id="sort" class="form-select" data-sort>
                      ...
                      <option value="risk level high" data-sort="Risk level" data-order="High,Medium,Low">
                        Risk level (high to low)
                      </option>
                      <option value="risk level low" data-sort="Risk level" data-order="Low,Medium,High">
                        Risk level (low to high)
                      </option>
                      <option value="client asc" data-sort="Client" data-order="asc">Client (Ascedning order)</option>
                      <option value="client desc" data-sort="Client" data-order="desc">
                        Client (Descending order)
                      </option>
                      <option value="client asc" data-sort="Date added" data-order="asc" data-format="date">
                        Date added (Ascedning order)
                      </option>
                      <option value="client desc" data-sort="Date added" data-order="desc" data-format="date">
                        Date added (Descending order)
                      </option>
                    </select>
                  </div>
                </div>
                <div class="col mw-fit-content">
                  <button class="btn btn-tertiary text-nowrap d-none d-md-block me-0" type="button" data-clear>
      ...
      */
        ...
        var observer = new IntersectionObserver(
          function (entries) {
            ...
            if (entries[0].boundingClientRect.top < 1) el.classList.add('stuck');
