...
<template>
  ...
  <main class="main--marketplace">
    ...
    <div class="admin-panel mb-5">
      ...
      <Chart class="chart chart--animate" data-max="4" data-min="0" data-type="column" data-yaxis="0,2,4" data-guidelines="0,1,2,3,4" style="--chart-height-lg:14%;">
        <table>
          <thead>
            <tr>
              <th>Time period</th>
        ...
        <Actionbar data-search="Property" :data-search-value="search" data-for="inspectionsTable">
          ...
          <div class="dialog__wrapper">
            ...
            <dialog class="dialog--list" >
              <div class="mb-0" >
                <input type="radio" name="sort" data-sort="Date added" data-order="asc" data-format="date" id="date-added-oldest" value="date-added-oldest" :checked="sort?.includes('date-added-oldest')" :autofocus="sort?.includes('date-added-oldest')">
                <label for="date-added-oldest" class="radio--tick pb-0" >Date added (Oldest to newest)</label>
                
                <input type="radio" name="sort" data-sort="Date added" data-order="desc" data-format="date" id="date-added-newest" value="date-added-newest" :checked="sort?.includes('date-added-newest')" :autofocus="sort?.includes('date-added-newest')">
            ...
            <AppliedFilters data-nosubmit class="applied-filters--hide-title" ref="filters">
              ...
              <Accordion>
                <details>
                  ...
                  <label class="mb-0"><input type="checkbox" :checked="formTypes?.includes('material')" value="material" data-name="form-type[material]" name="form-type[]" data-filter-text="Material information" data-filter="Form type">Material information</label>
                  <label class="mb-0"><input type="checkbox" :checked="formTypes?.includes('ta6')" value="ta6" data-name="form-type[ta6]" name="form-type[]" data-filter-text="TA6" data-filter="Form type">TA6</label>
                  <label class="mb-0"><input type="checkbox" :checked="formTypes?.includes('ta7')" value="ta7" data-name="form-type[ta7]" name="form-type[]" data-filter-text="TA7" data-filter="Form type"> TA7</label>
                  <label class="mb-4"><input type="checkbox" :checked="formTypes?.includes('ta10')" value="ta10" data-name="form-type[ta10]" name="form-type[]" data-filter-text="TA10" data-filter="Form type"> TA10</label>
                </details>
                <details>
                  <summary class="py-0"><span class="label">Status</span></summary>

                  <label class="mb-0"><input type="checkbox" :checked="status?.includes('not-started')" value="not-started" data-name="status[not-started]" name="status[]" data-filter-text="Not started" data-filter="Status">Not started</label>
                  <label class="mb-0"><input type="checkbox" :checked="status?.includes('in-progress')" value="in-progress" data-name="status[in-progress]" name="status[]" data-filter-text="In progress" data-filter="Status">In progress</label>
                  <label class="mb-4"><input type="checkbox" :checked="status?.includes('complete')" value="complete" data-name="status[ta7]" name="status[]" data-filter-text="Complete" data-filter="Status"> Complete</label>
                </details>
                <details>
                  ...
                  <div class="row" data-filter-text="Date between: $1 - $2">
                    <div class="col-5">
                      ...
                      <label>Date from
                        <span>
                          <input type="date" name="datefrom" :value="route.query['datefrom']" data-filter-text="Date from - $value" data-filter="Date added" data-date-from/>
                    ...
                    <div class="col-5 offset-1">
                      ...
                      <label class="mb-5">Date to
                        <span>
                          <input type="date" name="dateto" :value="route.query['dateto']" data-filter-text="Date to - $value" data-filter="Date added" data-date-to/>
                          <span class="suffix fa-regular fa-calendar pe-none" aria-hidden="true"></span>
                        </span>
                      </label>
    ...
    <dialog id="cancel" class="dialog--transactional" >
      ...
      <button class="dialog__close">Close</button><i class="fa-light fa-circle" aria-hidden="true"><i class="fa-regular fa-trash-can" aria-hidden="true"></i></i>
      
      <span class="h3">Cancel property information forms</span>
      <div class="mh-lg">
        <p>Continuing will permanently cancel all property information forms for this client. We will notify the solicitor that the forms will not be completed online.</p><p>Are you sure you’d like to continue?</p>
        <form><button class="btn btn-secondary" formmethod="dialog">Close</button><a href="?cancel" class="btn btn-primary" id="cancelBtn">Cancel forms</a></form>
      </div>
    </dialog>
