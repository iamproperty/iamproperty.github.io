<template>
  <div>
        ...
        <form id="search" slot="actions">
          <div>
            ...
            <input
              ...
              name="search"
              type="text"
              placeholder="Search by keyword, property, agent or ap ref"
              autocomplete="off"
              class="input--inline"
            />
          </div>
    ...
    <datalist id="search-terms">
      <option v-for="(value, index) in searchTerms" :key="index" :data-link="value.url">
    ...
    <main>
      <div class="container pt-4">
        ...
        <h2>Your snapshot</h2>
        <Table
          :fields="[{ key: 'Property valuations' }, { key: 'Pre-approval valuations' }, { key: 'PAM properties' }]"
          :items="[]"
        ></Table>
