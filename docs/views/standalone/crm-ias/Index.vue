        ...
        <form id="form" novalidate action="/standalone/crm-ias/page2">
          <div class="form-panel" >
            ...
            {"matches":"any","if":"hide","target":"#first-button"}
              ...
              <div class="row">
                ...
                <div class="col">
                  <label class="d-inline-block"><input type="radio" name="lead-type" value="uploading-contract" required >Valuer <br/>(uploading contract now)</label>
                </div>
                
                <div class="col">
                  <label class="d-inline-block"><input type="radio" name="lead-type" value="not-uploading" required >Valuer <br/>(not uploading contract now)</label>
                </div>
                
                <div class="col mw-fit-content">
                  <label class="d-inline-block"><input type="radio" name="lead-type" value="branch-lead" required > Branch lead</label>
                </div>
              </div>
              </fieldset>
          ...
          <div class="form-panel js-hide" id="second-form">
            ...
            <fieldset id="uploading" class="js-hide">
              ...
              <label class="col-md-4">Starting bid <span><span class="prefix">£ <small>GBP</small></span><input type="text" name="starting-bid" data-required /></span></label>

              <label class="col-md-4">Reserve price <span><span class="prefix">£ <small>GBP</small></span><input type="text" name="reserve-price" data-required /></span></label>

              <FileUpload><input type="file" name="files[]" multiple="multiple" accept=".pdf, .csv, .jpg, .png" /></FileUpload>
            ...
            <label>Choose a vendor to contact (optional)
            ...
            <div class="row"><label class="col-md-4">Date to contact (Optional) <span><input type="date" name="date" /><span class="suffix fa-regular fa-calendar"></span></span></label></div>
            
            <div class="row">
              <div class="col-md-4">
                <label>Time to contact (optional)
            ...
            <small class="d-block pb-3">Office opening hours:<br/>
            ...
            <fieldset>
              ...
              <label>
                ...
                That the vendor is aware that their information will be shared with iamsold, and that they are happy for us to contact them in relation to the auction service.
              </label>
            ...
            <fieldset>
              <label>
                ...
                That the vendor is aware that calls to and from iamsold are recorded for training and monitoring purposes.
              </label>
            ...
            <fieldset>
              <label>
                ...
                That you have completed an assessment of the vendor circumstances in order to identify that auction would be a suitable method of sale for them.
              </label>
