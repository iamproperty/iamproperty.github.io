<template>
  <div>
      ...
      <div class="container pt-1">
        <div class="row">
          <div class="ms-auto col-4">
            <div class="text-end">
              <Logo id="movebutler" class="pe-0 pb-0"></Logo>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="ms-auto col-6">
            <address class="text-end text-primary mb-3 small">
              Floor6, Arden House,<br />
              Regent Centre, Gosforth,<br />
              Newcastle upon Tyne,<br />
              NE3 3LU<br />
              <strong>Call:</strong> 0345 646 0302<br />
              <strong>Email:</strong> enquiries@iam-sold.co.uk<br />
              <strong>www.iamproperty.com</strong>
            </address>
          </div>
        </div>
        ...
        <Table
          ...
          :items="[
            {
              date_added: '24 Jan 2021',
              branch: 'Branch1',
              type: 'Vendor',
              transation_address: '2 Hepple Way, NE3 3HS',
            },
            {
              date_added: '24 Jan 2021',
              branch: '<span class=\'text-danger\'>Branch1</span>',
              type: 'Vendor',
              transation_address: '2 Hepple Way, NE3 3HS',
            },
            {
          ...
          class="table-striped border-0"
          headingclass="bg-secondary"
        ></Table>
        ...
        <p class="h2 text-secondary">Joe Bloggs</p>
        <p class="small mt-0">
          Note: To comply with the Consumer Protection from Unfair Trading Regulations 2008, the information should be
          displayed by the person marketing the property for anyone to view, this might include your company website or
    ...
    <footer class="bg-primary pt-4">
      <div class="container">
        <p>© Copyright iamsold 2022 - All rights reserved</p>
        <p>172.19.0.5</p>
      </div>
    </footer>
  </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      searchTermGen: {
        get() {
          if (this.savedSearchTerm) return this.savedSearchTerm;
