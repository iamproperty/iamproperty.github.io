<script setup>
  ...
  const accountName = 'John Jones NE';
</script>
<template>
  <nav>
    <Nav>
  ...
  <main>
    ...
    <p class="lead"><strong>46</strong> Client added in total</p>

    <a href="/patterns/switching-account" class="btn btn-tertiary">Go back to the Switching account pattern page</a>
  </main>
</template>
