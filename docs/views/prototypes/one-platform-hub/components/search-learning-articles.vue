...
<template>
  <form method="get" action="https://iampropertysuccesshub.thinqi.co.uk/search" target="_blank" @submit="trackSearch">
    ...
    <label>
      ...
      <Search
        class="search--stylised"
        data-url="https://iampropertysuccesshub.thinqi.co.uk/api/search/discovery?language=en&query="
        data-schema="results"
        data-min-length="5"
      >
        <input
        ...
        <datalist @click="openLink">
          <option
            data-url="https://iampropertysuccesshub.thinqi.co.uk/repository/resource/cfaf133d-7029-4fca-9257-0f67512faffd/overview"
            data-value="CRM solution overview"
          >
