<template>
  <main>
    <div class="container pb-5 mb-5">
      ...
      <p class="note">
        <strong>Note: </strong>The data is added to the page using a table element which is then converted into a chart
        by using a combination of CSS and supporting SVG's.
      </p>
    </div>
    ...
    <div class="container visualtest">
      <h2>Default chart</h2>
      <Chart
        class="chart chart--animate chart--show-totals"
        data-max="1800"
        data-min="0"
        data-type="column"
        data-yaxis="0,200,400,600,800,1000,1200,1400,1600,1800"
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <Chart
              ...
              data-min="0"
              data-type="column"
              data-yaxis="0,20,40,60"
              data-guidelines="0,10,20,30,40,50,60"
            >
              <table>
                <thead>
                  <tr>
    ...
    <div class="container visualtest">
      <h2>Bar chart</h2>
      <Chart
        class="chart chart--display-data chart--animate"
        data-max="50"
        data-min="0"
        data-type="bar"
        data-yaxis="45%"
    ...
    <div class="container visualtest">
      ...
      <Chart
        ...
        data-min="0"
        data-max="700"
        data-yaxis="0,100,200,300,400,500,600,700"
        data-increment="0.1"
        data-start="10"
        data-end="26"
        data-xaxis="10,12,14,16,18,20,22,24,26"
        data-slope
        data-yint
      >
        <table>
