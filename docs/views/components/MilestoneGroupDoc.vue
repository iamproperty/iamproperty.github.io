  ...
  const taskData = ref([
    {
      ...
      description:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempus arcu mi, ut pulvinar urna dictum in. Integer sed nunc sit amet nulla fermentum iaculis.',
      active: true,
      subtask_order: '1',
      actions: [],
...
<template>
  <TrackEvents selector="iam-milestone-group" :events="['hide-future-items', 'show-future-items']"></TrackEvents>
  ...
  <main>
    ...
    <p class="lead md-col-end-7">
      A component for wrapping a set of milestones and styling them as a list, as well as well allowing for hiding and
    ...
    <div class="visualtest container">
      ...
      <p>
        A Milestone Group component is designed to group multiple Milestone components together. It does the following:
      </p>
      <ul>
        <li>Adds a vertical line between any milestones added within it</li>
        <li>
          Allows the developer to visually reverse the order of the items to show them in reverse chronological order
          for example.
        </li>
        <li>
          Allows the developer to only show the current milestone and it's predecessors, and hide the future milestones
          by default until a show more toggle is pressed.
        </li>
      </ul>
      ...
      <MilestoneGroup data-show-all-toggle="true" class="reverse-items milestone-group mb-3">
        ...
        <Milestone :data-items="JSON.stringify(taskData)" data-status="Current">
          <div slot="milestone-intro">
            ...
            <p>
              Some summary text about this milestone. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
              tempus arcu mi, ut pulvinar urna dictum in.
            </p>
          </div>
        </Milestone>
...
`}}</code></pre>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>No</td>
              <td>
                This property is used to hide any child milestones that are after the current milestone, as well as
                adding a toggle to show all of the milestones.
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table>
          ...
          <tbody>
            <tr>
              <th>reverse-items</th>
              <td>
                Visually reverses the order of the milestone items in the group so that the last item in the list is
                first
              </td>
            </tr>
          </tbody>
      ...
      <template #criteria>
        <ul>
          <li>
            A milestone group with the reverrse-items class should show the child items in the reverse order to how they
            are added.
          </li>
          <li>
            A milestone group with the attribute data-show-all-toggle should show a button with an 'eye icon alongside
            it'.
          </li>
          <li>
            A milestone group with the attribute data-show-all-toggle should only show the milestone with a current
            status and all those before it.
          </li>
