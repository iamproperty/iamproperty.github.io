<template>
  <main>
    ...
    <div class="container pb-0">
      ...
      <p class="lead">The collapsible side menu is a simple single-column list that can be expanded or collapsed within a page.</p>

      <h2>Introduction</h2>

      <p>Collapsible side menus should be aligned to the side of a page. They feature three states: expanded, collapsed, collapsed-hover. They are most useful for housing sub navigation items to linked pages. They can also include other relevant content such as a H3 header, quick filter options, and page summaries.</p>
    </div>
    ...
    <div class="container ">
      ...
      <ol>
        ...
        <li>‘Collapse’ button. On desktop this will only show when the user hovers over the ‘Default state container’.</li>
        <li>‘Collapsed state’ container. On desktop, hovering on this area will open the ‘Collapsed hover state’. On tablet and mobile, selecting this area will open the ‘expanded’ state.</li>
        <li>‘Expand’ button.</li>
        <li>‘Desktop only - Collapsed hover state’ container. If the user moves their pointer out of the container it will return to ‘Collapsed state.</li>   
      </ol>
    </div>
    ...
    <div class="container pt-5 pb-0">
      ...
      <p>On desktop, the menu should default to the ‘expanded’ state with the ‘expand’ button hidden. It should be left aligned alongside page content.</p>
      ...
      <p>The side menu should take up 50% of the screen on tablet when expanded. If the height of the content within the menu exceeds the menu height, the content should scroll within the menu.</p>

      <h3>Tablet</h3>
      <p>On tablet, the menu should default to the ‘collapsed’ state with the ‘expand’ button visible. It should be left aligned alongside page content.</p>
      ...
      <p>The height of the menu should stretch to the full height of the (page - navbar). The menu has an optional H3 header, quick filter, and sub navigational items.</p>
      <p>The side menu has a max width of 21.8rem (350px) on desktop when expanded. If the height of the content within the menu exceeds the menu height, the content should scroll within the menu.</p>
    ...
    <div class="container pt-5 pb-0">
      ...
      <p>Sub-navigational items are used to navigate to other pages linked to the one the user is accessing. For example. When on a record for a property in the CRM, sub navigational items could be used to link various pages relating to the property record together like overview, viewings, appraisals, marketing, compliance etc. They should only be used within the collapsible side menu.</p>
