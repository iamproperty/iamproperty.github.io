...
<template>
  ...
  <main>
    ...
    <p class="lead">
      The advanced select field is an interactive element typically used in forms to allow users to filter a list of
    ...
    <ul class="mb-5">
      <li>
        Selecting the field or chevron should activate the dropdown and set the field to active so the user can begin
        typing
      </li>
