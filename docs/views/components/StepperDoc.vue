<template>
  <main>
    <div class="container">
      ...
      <p>Orientate the user with their progress through a form journey with multiple steps.</p>
    </div>
    ...
    <Stepper class="visualtest">
      ...
      <Step url="/step" current>Current step</Step>
      <Step url="/step">Future step</Step>
    </Stepper>
