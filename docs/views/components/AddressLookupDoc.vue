<template>
  <main>
    ...
    <div class="container visualtest">
      ...
      <p class="note">
        <strong>Note:</strong> To have the manual address lookup open on page load include the data attribute
        [data-manual].
      </p>
    </div>
    ...
    <div class="container visualtest">
      <AddressLookup
        data-url="/addressess.json?search="
        data-use-label="Use existing address"
        data-use='{"address_1":"Gosforth Library & Learning Centre","address_2":"Regent Farm Road","address_3":"","postcode":"NE3 3HD","city":"NEWCASTLE UPON TYNE","county":"Tyne and Wear","country":"England"}'
      >
