<template>
  <main>
    ...
    <div class="container pb-5">
      ...
      <h2>Introduction</h2>
      <p class="lead">Alerts communicate essential information. They’re positioned at the top of the screen to be noticeable and require user action to disappear.</p>
      <h3>Overview</h3>
      <p>Alerts are visually prominent components primarily used to deliver important information or messages to users. This could include announcements, alerts, warnings, promotional messages, or calls to action. Banners are often used for time-sensitive or critical updates and persist until they are either dismissed or the purpose of the message is fulfilled.</p>
    ...
    <div class="container">
      ...
      <p>Close button: Alerts often include a visible close button (typically an “x” icon) in the corner or somewhere within the alert itself. Users can click or tap on the close button to dismiss the alert.</p>

      <p>User action: Alerts may require users to perform a specific action to dismiss them. This action can be clicking on a confirmation button, selecting an option, or completing a task related to the alert’s content.</p>

      <p>*Alerts will persist in certain cases. If a user dismisses an alert without performing the action it is urging, it will return a day later to urge them to complete the action.</p>
    </div>
    ...
    <div class="container">
      ...
      <div class="row mb-4">
        <div class="col-sm-6 pe-5">
          <Notification data-type="demo"><strong>Timer set</strong><br/> Alert message will display here <a href="/components/alert">Cancel</a></Notification>
          <span class="d-block mb-4">Informational notification</span>
        </div>
        <div class="col-sm-6 pe-5">
          <Notification data-type="demo" data-status="success"><strong>Property added</strong><br/> Alert message will display here <a href="/components/alert">Undo</a></Notification>
          <span class="d-block mb-4">Success notification</span>
        </div>
        <div class="col-sm-6 pe-5">
          <Notification data-type="demo" data-status="warning"><strong>Action incomplete</strong><br/> Alert message will display here <a href="/components/alert">Dismiss</a></Notification>
          <span class="d-block mb-4">Warning notification</span>
        </div>
        <div class="col-sm-6 pe-5">
          <Notification data-type="demo" data-status="danger"><strong>Transaction failed</strong><br/> Alert message will display here <a href="/components/alert">Retry</a></Notification>
    ...
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2">
        <div class="col">
          ...
          <p><strong class="text-complete d-block">Do</strong> Use one alert that takes the user to a notification centre where they can address multiple alerts without being disrupted.</p>
        </div>
        <div class="col">
          <img :src="alertDont" alt="" class="mb-3" />
          <p><strong class="text-danger d-block">Don't</strong> Don`t unnecessarily alarm users with multiple non-urgent alerts stacked at the top of the screen.</p>
        </div>
        <div class="col">
          <img :src="alertDo2" alt="" class="mb-3" />
          <p><strong class="text-complete d-block">Do</strong> Display again if unresolved. If a user dismisses a alert without resolving the issue, display it again at the next possible occasion, without overwhelming the user (e.g. the next time session).</p>
        </div>
        <div class="col">
          <img :src="alertDont2" alt="" class="mb-3" />
          <p><strong class="text-danger d-block">Don't</strong>Don’t let alerts time out. Banners should only disappear on user interaction (dismissing or completing a task) or when the information is no longer relevant (e.g. updating failed payment details).</p>
        </div>

        <div class="col">
          <img :src="alertDo3" alt="" class="mb-3" />
          <p><strong class="text-complete d-block">Do</strong> Be clear and concise with the content and actions in the alert. </p>
        </div>
        <div class="col">
        ...
        <div class="col">
          ...
          <p><strong class="text-complete d-block">Do</strong> Display alerts horizontally or vertically to best use the space available on a screen. When vertical, stack content and align to the left</p>
        </div>
      </div>
    </div>
