<template>
  <main>
    ...
    <div class="container pb-0">
      ...
      <p class="lead">Radio buttons allow the user to select one option from a set. Use radio buttons when the user needs to see all available options. If available options can be collapsed, consider using a dropdown menu because it uses less space.</p>
    </div>
    ...
    <div class="container pb-0">
      ...
      <p>Standard radio buttons feature a button alongside a label. The label should clearly explain the option that can be selected. The button should sit in a container of 2.5rem (40px) with 0.5rem (8px) of padding between the button and the label.</p>
    </div>
    ...
    <div class="container pb-0">
      ...
      <p>Card radio buttons feature similar styling to the ‘text and icon filter card’ on the cards style guide. The radio button provides user with an optional visual aid (icon) as well as a text label to ensure the user gains a quicker understanding of the radio button selection. This radio button can also apply a drop shadow with a default colour of HEX #000000, 6px Y-axis and 12px blur with an opacity of 15%.</p>
    ...
    <div class="container pb-0">
      ...
      <p>These are best used at the beginning of a section of the form to determine which type of fields are presented to the user.</p>
      <p>For example, we might use this type of radio button for the options ‘Existing Property’ and ’New Property’ then show the relevant fields below once the option has been selected.</p>
...
<label for="radio">Input field label</label>`}}</code></pre>
        ...
        <details>
          ...
          <p class="pb-3">The radio input field uses the same Vue component as the input field, the type just needs to be set to 'radio'. The name attribute is required for the radio input field, this attribute should match other radio input fields in a radio button group.</p>
          <Readme></Readme>
        </details>
      </Tabs>
    </div>
