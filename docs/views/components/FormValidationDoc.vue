<template>
  <main>
    ...
    <div class="container pb-0">
      ...
      <p class="lead">Form validation on an input field can be triggered by either using the default form validation api and the supported CSS rules. Or set classes (.is-valid and .is-invalid) can be used so that server side validation can be used.</p>
    ...
    <div class="container pb-5">
      ...
      <p>When the field value is incorrect or empty when required we should show an error state for the field with an appropriate error message</p>
