<script setup>
  ...
  const body_fs = window.getComputedStyle(document.querySelector('body')).getPropertyValue('--body-fs');

  const h1_fs = parseFloat(body_fs) * roundNearQtr(Math.pow(1.2, 6)) + 'rem';
  const h1_fs_px = parseFloat(h1_fs) * 16;

  const h1_lh = parseFloat(roundNearQtr(parseFloat(h1_fs) * 1.2)) + 'rem';
  const h1_lh_px = parseFloat(h1_lh) * 16;
  const h1_pb = parseFloat(roundNearQtr(parseFloat(h1_fs) * 1.2)) + 'rem';
  const h1_pb_px = parseFloat(h1_pb) * 16;

  const h2_fs = parseFloat(body_fs) * roundNearQtr(Math.pow(1.2, 5)) + 'rem';
  const h2_fs_px = parseFloat(h2_fs) * 16;

  const h2_lh = parseFloat(roundNearQtr(parseFloat(h2_fs) * 1.2)) + 'rem';
  const h2_lh_px = parseFloat(h2_lh) * 16;
  const h2_pb = parseFloat(roundNearQtr(parseFloat(h2_fs) * 1.2)) + 'rem';
  const h2_pb_px = parseFloat(h2_pb) * 16;
...
<template>
  <main>
    ...
    <div class="container">
      ...
      <p class="lead">
        Most headings will have a max-width of {{ maxWidth }} ({{ maxWidth_px }}px) applied to aid readability, with the
        exception of H1 and H2, which will have an auto width.
      </p>
      <p class="lead">
        ...
        <div class="col">
          <div class="row">
            <div class="col-12 col-sm-7 mb-2">
              <span class="h1"
                >This is heading 1<span class="lineheight-demo" :style="`height:${h1_pb}!important`"></span
              ></span>
            </div>
            <div class="col-12 col-sm-4 mb-5 ms-auto">
              <span class="small extra-small"
                >H1<br />Font-family: Qanelas<br />Font-weight: Bold<br />Font-size: {{ h1_fs }} ({{
                  h1_fs_px
                }}px)<br />Letter-spacing: 0px<br />Line-height: {{ h1_lh }} ({{ h1_lh_px }}px)<br />Padding-bottom:
                {{ h1_pb }} ({{ h1_pb_px }}px)</span
              >
            </div>
          </div>
          <div class="row">
            <div class="col-12 col-sm-7 mb-2">
              <span class="h2"
                >This is heading 2<span class="lineheight-demo" :style="`height:${h2_pb}!important`"></span
              ></span>
            </div>
            <div class="col-12 col-sm-4 mb-5 ms-auto">
              <span class="small extra-small"
                >H2<br />Font-family: Qanelas<br />Font-weight: Bold<br />Font-size: {{ h2_fs }} ({{
                  h2_fs_px
                }}px)<br />Letter-spacing: 0px<br />Line-height: {{ h2_lh }} ({{ h2_lh_px }}px)<br />Padding-bottom:
                {{ h2_pb }} ({{ h2_pb_px }}px)</span
              >
            </div>
          </div>
          <div class="row">
            <div class="col-12 col-sm-7 mb-2">
              <span class="h3"
                >This is heading 3<span class="lineheight-demo" :style="`height:${h3_pb}!important`"></span
              ></span>
            </div>
            <div class="col-12 col-sm-4 mb-5 ms-auto">
              <span class="small extra-small"
                >H3<br />Font-family: Qanelas<br />Font-weight: Semi-Bold <br />Font-size: {{ h3_fs }} ({{
                  h3_fs_px
                }}px)<br />Letter-spacing: 0px<br />Line-height: {{ h3_lh }} ({{ h3_lh_px }}px)<br />Padding-bottom:
                {{ h3_pb }} ({{ h3_pb_px }}px)</span
              >
            </div>
          </div>
          <div class="row">
            <div class="col-12 col-sm-7 mb-2">
              <span class="h4"
                >This is heading 4 <span class="lineheight-demo" :style="`height:${h4_pb}!important`"></span
              ></span>
            </div>
            <div class="col-12 col-sm-4 mb-5 ms-auto">
              <span class="small extra-small"
                >H4<br />Font-family: Qanelas<br />Font-weight: Semi-Bold<br />Font-size: {{ h4_fs }} ({{
                  h4_fs_px
                }}px)<br />Letter-spacing: 0px<br />Line-height: {{ h4_lh }} ({{ h4_lh_px }}px)<br />Padding-bottom:
                {{ h4_pb }} ({{ h4_pb_px }}px)</span
              >
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-4 mb-5 ms-auto">
              <span class="small extra-small"
                >.lead<br />Font-family: Qanelas<br />Font-weight: Semi-Bold<br />Font-size: 1.125rem (18px)<br />Letter-spacing:
                0px<br />Line-height: 1.75rem (28px)<br />Padding-bottom: 3rem (48px)</span
              >
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-4 mb-5 ms-auto">
              <p class="small extra-small pb-2">
                body<br />Font-family: Qanelas<br />Font-weight: Normal<br />Font-size: 1rem (16px)<br />Letter-spacing:
                0px<br />Line-height: auto
              </p>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-4 mb-5 ms-auto">
              <p class="small extra-small pb-2">
                p<br />Font-family: Qanelas<br />Font-weight: Normal<br />Font-size: 1rem (16px)<br />Letter-spacing:
                0px<br />Line-height: 1.5rem (24px)<br />
                Padding-bottom: 3rem (48px)
              </p>

              <p class="small extra-small">p:has(+ p)<br />Padding-bottom: 1.5rem (24px)</p>
            </div>
          </div>
          <!-- Small -->
          <div class="row">
            <div class="col-12 col-sm-7 mb-2">
              ...
              <p class="small">
                ...
                consequat.<span class="lineheight-demo" :style="`height:3rem!important`"></span>
              </p>
            </div>
            <div class="col-12 col-sm-4 mb-5 ms-auto">
              <p class="small extra-small pb-2">
                .small, small<br />Font-family: Qanelas<br />Font-weight: Medium<br />Font-size: 0.875rem (14px)<br />Letter-spacing:
                0px<br />Line-height: 1.5rem (24px)<br />Padding-bottom: 3rem (48px)
              </p>
            </div>
          </div>
        </div>
