<template>
  <main>
    ...
    <div class="container pb-0">
      <h2>Buttons</h2>
      <p class="lead">
        Buttons are generally used as an anchor link to another page or to perform an action such as submitting a form.
      </p>
      <h3>Primary</h3>
      <p>
        ...
        dialog). Not every screen requires a primary button. A filter overlay of 85% brightness will be applied to the
        default states for the active state.
      </p>
    </div>
    ...
    <div class="container visualtest pb-5 pe-none">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4">
          <a href="/components/buttons" class="btn btn-primary colour-primary fa-plus-large">Lorum ipsum</a>
        </div>
        <div class="col-sm-6 col-md-4">
    ...
    <div class="container pb-0">
      <h4 class="text-body">Primary button (with interactive prompt)</h4>
      <p>
    ...
    <div class="container visualtest pb-5 pe-none">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4">
          <a href="/components/buttons" class="btn btn-primary colour-primary btn--prompt">Lorum ipsum</a>
        </div>
        <div class="col-sm-6 col-md-4">
    ...
    <div class="container pb-0">
      <h4 class="text-body">Primary button (small)</h4>
    ...
    <div class="container visualtest pb-5 pe-none">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4">
          <a href="/components/buttons" class="btn btn-primary colour-primary btn-sm">Lorum ipsum</a>
        </div>
        <div class="col-sm-6 col-md-4">
    ...
    <div class="container pb-0">
      <h4 class="text-body">Primary button (compact)</h4>
      <p>
    ...
    <div class="container visualtest pb-5 pe-none">
      ...
      <div class="row">
        <div class="col-5 col-sm-3">
          <a href="/components/buttons" class="btn btn-primary colour-primary btn-compact fa-plus-large">Lorum ipsum</a>
        </div>
        <div class="col-7 col-sm-3">
          <a href="/components/buttons" class="btn btn-primary colour-primary hover btn-compact fa-plus-large"
            >Lorum ipsum</a
          >
        </div>
        <div class="col-7 col-sm-3">
          <a href="/components/buttons" class="btn btn-primary colour-primary active btn-compact fa-plus-large"
            >Lorum ipsum</a
          >
        </div>
      </div>
    ...
    <div class="container pb-0">
      <h4 class="text-body">Primary button (complete)</h4>
      <p>
        Use a ‘complete’ primary button when a user has completed a stage and can then access/view the outcome or to
    ...
    <div class="container pb-0">
      <h4 class="text-body">Secondary button (with icon)</h4>
      <p>
    ...
    <div class="container pb-0">
      <h4 class="text-body">Secondary button (with interactive prompt)</h4>
      <p>
    ...
    <div class="container pb-0">
      <h4 class="text-body">Secondary button (opening filter dialog modal)</h4>
    ...
    <div class="container visualtest pb-5 pe-none">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-4">
          ...
          <button class="btn btn-secondary btn-filter hover" data-model="example2">Filter by</button>
    ...
    <div class="container pb-0">
      <h4 class="text-body">Secondary button (form field acting as a button)</h4>
    ...
    <div class="container pb-0">
      <h4 class="text-body">Secondary button (small)</h4>
      <p>When there is limited space a small button variant can be used.</p>
    </div>
    ...
    <div class="container pb-0">
      <h4 class="text-body">Secondary button (compact)</h4>
      <p>
        When space is very limited or when the same button needs to be used multiple times on a page a compact secondary
        button may be suitable. A ‘solid’ icon should always be used for compact buttons.
      </p>
    </div>
    ...
    <div class="container visualtest pb-5 pe-none">
      ...
      <div class="row">
        ...
        <div class="col-7 col-sm-3">
          <a href="/components/buttons" class="btn btn-secondary colour-secondary hover btn-compact fa-save"
            >Lorum ipsum</a
          >
        </div>
        <div class="col-7 col-sm-3">
          <a href="/components/buttons" class="btn btn-secondary colour-secondary active btn-compact fa-save"
            >Lorum ipsum</a
          >
        </div>
      </div>
      <div class="row">
        <div class="col-5 col-sm-3">
          <a href="/components/buttons" class="btn btn-secondary colour-danger btn-compact fa-trash">Lorum ipsum</a>
        </div>
        <div class="col-7 col-sm-3">
          <a href="/components/buttons" class="btn btn-secondary colour-danger hover btn-compact fa-trash"
            >Lorum ipsum</a
          >
        </div>
        <div class="col-7 col-sm-3">
          <a href="/components/buttons" class="btn btn-secondary colour-danger active btn-compact fa-trash"
            >Lorum ipsum</a
          >
        </div>
      </div>
    ...
    <div class="container pb-0">
      <h3>Tertiary</h3>
      <p>
        Use a tertiary button for links such as low level navigations. A filter overlay of 85% brightness will be
    ...
    <div class="container pb-0">
      <h4 class="text-body">Tertiary button (with icon)</h4>
    ...
    <div class="container visualtest pb-5 pe-none">
      <div class="row">
        <div class="col-sm-6 col-md-4">
          <p class="lead pb-2">Default state</p>
          <a href="/components/buttons.pdf" class="btn btn-tertiary"
            ><span>Lorum ipsum</span><i class="fa-light fa-arrow-down-to-bracket"></i
          ></a>
        </div>
        <div class="col-sm-6 col-md-4">
          <p class="lead pb-2">Hover/Focus state</p>
          <a href="/components/buttons" class="btn btn-tertiary hover"
            ><span>Lorum ipsum</span><i class="fa-light fa-arrow-down-to-bracket"></i
          ></a>
        </div>
        <div class="col-sm-6 col-md-4">
          <p class="lead pb-2">Active state</p>
          <a href="/components/buttons" class="btn btn-tertiary active"
            ><span>Lorum ipsum</span><i class="fa-light fa-arrow-down-to-bracket"></i
          ></a>
        </div>
      </div>
    ...
    <div class="container pb-0">
      ...
      <p>
        When any of the buttons above are disabled we should:<br />
        - Disable the normal hover state for that button<br />
        - Reduce the opacity of the button to 40%<br />
        - Add a native browser ‘blocked’ symbol when the user hovers over the button.
      </p>
    </div>
    ...
    <div class="container pb-0">
      ...
      <p>
        ...
        (1.5rem) to 16px (1rem). Compact buttons can still have the smaller padding of 8px (0.5rem) on desktop, tablet,
        and mobile.
      </p>
      <p>
        This reduced padding provides more flexibility when designing for mobile as more content can be displayed on the
        screen at once. The minimum padding does however ensure that the screen doesn’t become too cluttered and that
    ...
    <div class="container visualtest">
      <p>
        ...
        <a href="/components/buttons">industry's standard</a> dummy text ever since the 1500s, when an
        <a href="/components/buttons"><i class="fa-light fa-envelope"></i> unknown printer</a> took a galley of type and
    ...
    <div class="container visualtest pb-5 pe-none">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-4">
          ...
          <p>
            <a href="/components/buttons" class="active"><i class="fa-light fa-envelope"></i> unknown printer</a>
          </p>
        </div>
      </div>
      <div class="row">
        ...
        <table>
          ...
          <tbody class="text-body">
            ...
            <tr>
              ...
              <td>08.06.2023</td>
              <td>
                - Increased icon size on primary and secondary buttons to 1.125rem and ‘compact’ primary and secondary
                buttons to 1.25rem<br />
                - Decreased font weight on tertiary buttons to 500<br />
                - Updated style of ‘dark’ tertiary button to include green underline<br />
                - Added mobile button padding guidance
              </td>
            </tr>
            <tr>
              <td>V1 added</td>
