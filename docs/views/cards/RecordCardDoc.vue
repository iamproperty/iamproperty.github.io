...
<template>
  <main>
    ...
    <p class="lead">
      Record cards can be used to display key information in compact and scannable lists of cards that users can preview
      quickly. When clicked, they direct users to another page with the full extent of information on that list item.
    </p>
        ...
        <div class="col">
          ...
          <a href="/">
            <RecordCard :data-image="cardImg">
              ...
              <span
                >Updated by: John Smith<br />
                Updated on: 03/01/2024</span
              >
            </RecordCard>
          </a>
        </div>
        ...
        <div class="col">
          ...
          <a href="/">
            <RecordCard data-record="business">
              ...
              <span>£503 pcm</span>
              <span
                >4 <i class="fa-regular fa-bed-front me-1" title="bed"></i> 2
                <i class="fa-regular fa-bath me-1" title="baths"></i> 1
                <i class="fa-regular fa-couch me-1" title="sofa"></i
              ></span>
              <span
                ><strong>Updated by:</strong> John Smith<br />
                <strong>Updated on:</strong> 03/01/2024</span
              >
            </RecordCard>
          </a>
        </div>
    ...
    <p>
      Property cards can display a range of card types - from vendor profiles to business details - and to distinguish
      them, we can use an icon and a colour in the empty image state.
    </p>
