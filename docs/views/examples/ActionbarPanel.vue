  ...
  <main>
    ...
    <div class="container pt-5">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="admin-panel pb-1">
            <h2>With Actionbar</h2>
            ...
            <div class="row row-cols-1 row-cols-sm-2 pt-1" id="cards">
              <div class="col">
              ...
              <div class="col">
                <a href="/">
                  <Card>
                    Property 2
                    <span>Lorem ipsum</span>
                    <div><input type="checkbox" name="card2" id="card2"><label for="card2" class="m-0">Select card</label></div>
                  </Card>
                </a>
              </div>
            </div>
        ...
        <div class="col-md-6">
          <div class="admin-panel">
            <h2>With table and actionbar</h2>
