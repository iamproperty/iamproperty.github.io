...
class iamDarkMode extends HTMLElement {
  ...
  connectedCallback(): void {
    ...
    this?.innerHTML =
      `<label class="toggle"><input type="checkbox" name="dark-mode" /> <span style="all: unset!important;">Light mode</span></label>`;
    ...
    document.addEventListener('theme-change', () => {
      if (document.documentElement.classList.contains('dark-theme')) setDark();
      else unsetDark();
    });
